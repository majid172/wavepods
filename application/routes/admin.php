...
Route::middleware('admin')->group(function () {
    ...
    // Podcast Category
    Route::controller('PodcastCategoryController')->group(function () {
        Route::get('podcast-category', 'index')->name('category.index');
        Route::post('podcast-category/store', 'store')->name('category.store');
        Route::post('podcast-category/update', 'update')->name('category.update');
    });


    // Podcast 
    Route::controller('PodcastController')->group(function () {
        Route::get('podcast-new-episode', 'createPodcastEpisode')->name('podcast.new.episode');
        Route::post('podcast-new-episode-store', 'podcastEpisodeStore')->name('podcast.new.episode.store');
        Route::get('podcasts', 'index')->name('podcast.list');
        Route::post('podcast-store', 'store')->name('podcast.store');
        Route::post('podcasts-edit', 'update')->name('podcast.list.update');
        Route::get('podcast/episodes/{id}', 'episodeList')->name('podcast.episode.list');
        Route::post('podcast/episode/update', 'episodeUpdate')->name('podcast.episode.update');
    });

    // Subscriptions
    Route::controller('SubscriptionController')->group(function (){
        Route::get('subscriptions/list', 'index')->name('subscription.list');
    });
