...
<section class="breadcumb bg-img" style="background-image: url({{asset($activeTemplateTrue.'images/banner/banner-bg.jpg')}});">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcumb__wrapper">
                    <h2 class="breadcumb__title">@lang('419 Error')</h2>
                    <ul class="breadcumb__list">
                        ...
                        <li class="breadcumb__item"> <span class="breadcumb__item-text"> @lang('419 Error') </span> </li>
                    </ul>
                </div>
            </div>
        </div>
...
<!-- ==================== Footer Start Here ==================== -->
<footer class="footer-area section-bg-light bg-img" style="background-image: url({{asset($activeTemplateTrue.'images/footer/footer-bg.jpg')}});">
