                    ...
                    <div class="latest-episode-item__info">
                        ...
                        <div class="bottom-influencer d-flex align-items-center">
                            <div class="profile-block d-flex me-3">
                                ...
                                @if($episode->podcast->user && $episode->podcast->user->image != null)
                                    <img src="{{ getImage(getFilePath('userProfile').'/'.@ auth()->user()->image) }}" class="profile-block-image img-fluid" alt="">
                                @endif


                                <div>
                                    {{ucfirst(@$episode->podcast->user->firstname)}} {{ucfirst(@$episode->podcast->user->lastname)}}
                                    <img src="assets/images/latest-podcast/verified.png" class="verified-image img-fluid" alt="">
                                    <h5>
                            ...
                            <ul class="social-list">
                                @if($episode->podcast->user->facebook_url != null)
								<li class="social-list__item"><a href="{{@$episode->podcast->user->facebook_url}}" target="_blank" class="social-list__link" tabindex="-1"><i class="fab fa-facebook-f"></i></a> </li>
                                @endif
                                @if($episode->podcast->user->twitter_url != null)
								<li class="social-list__item"><a href="{{@$episode->podcast->user->twitter_url}}" target="_blank" class="social-list__link active" tabindex="-1"> <i class="fab fa-twitter"></i></a></li>
                                @endif
                                @if($episode->podcast->user->linkedin_url != null)
								<li class="social-list__item"><a href="{{@$episode->podcast->user->linkedin_url}}" target="_blank" class="social-list__link" tabindex="-1"> <i class="fab fa-linkedin-in"></i></a></li>
                                @endif
							</ul>
                        </div>
                        @endif
...
<section class="topics-area meet-podcasts py-60">
    <div class="container">
        ...
        <div class="row podcast-episode-slider ">

            @forelse($totalEpisode->load('podcast') as $item)
            <div class="single-topic mt-3">
                <div class="single-topic__thumb">
                    <img src="{{getImage(getFilePath('podcastEpisode').'/' . @$item->image_path .'/'. @$item->image )}}" alt="">
                </div>

                <div class="single-topic__content d-flex">
                    <a href="{{route('podcast.details', $item->id)}}" class="title">{{@$item->title}}</a>
                </div>
            </div>
            @empty
