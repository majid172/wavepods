                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="your-password" name="password" type="password"  class="form-control form--control checkUser">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <sapn class="input--icon " rel="#confirm-password">
                                            <i class="fa-solid fa-lock"></i>
                                        </sapn>
                                        <input id="confirm-password" name="password_confirmation" type="password"  class="form-control form--control checkUser">
                                    </div>
                                </div>
                                @if ($general->agree)
                                <div class="col-sm-12">
