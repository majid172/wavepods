            ...
            <div class="col-lg-4  mb-4">
                <div class="single-trending-episode">
                    ...
                    <div class="single-trending-episode__info">
                        ...
                        <p class="mb-0">{{Illuminate\Support\Str::limit($item->description,40)}}</p>

                        <div class="latest-episode-bottom d-flex justify-content-between mt-3">
                            <a href="{{route('podcast.episodes',$item->id)}}" class="btn btn-base btn--sm">{{@$item->episode->count()}} @lang('Episodes')</a>
                            <a href="{{route('user.subscription.payment', $item->id)}}" class="btn btn-base btn--sm">@lang('Subscribe')</a>
                        </div>
                    </div>
                </div>
            </div>
