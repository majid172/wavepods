                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="blog-item">
                                ...
                                <div class="blog-item__content">
                                    ...
                                    <a href="{{route('blog.details',['slug'=>slug($blog->data_values->title),'id'=>$blog->id])}}" class="btn--simple">{{__($blog->data_values->button)}} <span class="btn--simple__icon">@php
                                        echo @$blog->data_values->button_icon;
                                    @endphp</span></a>
                                </div>
                            </div>
                        </div>
