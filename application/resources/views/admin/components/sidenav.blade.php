    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar__menu-header">@lang('Podcast Management')</li>

                <li class="sidebar-menu-item {{menuActive('admin.podcast.new.episode')}}">
                    <a href="{{route('admin.podcast.new.episode')}}" class="nav-link ">
                        <i class="menu-icon las la-broadcast-tower"></i>
                        <span class="menu-title">@lang('Add new episodes')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.podcast.list')}}">
                    <a href="{{route('admin.podcast.list')}}" class="nav-link ">
                        <i class="menu-icon las la-podcast"></i>
                        <span class="menu-title">@lang('Podcasts')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.category.*')}}">
                    <a href="{{route('admin.category.index')}}" class="nav-link ">
                        <i class="menu-icon lab la-usb"></i>
                        <span class="menu-title">@lang('Categories')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.subscription.list')}}">
                    <a href="{{route('admin.subscription.list')}}" class="nav-link ">
                        <i class="menu-icon las la-radiation-alt"></i>
